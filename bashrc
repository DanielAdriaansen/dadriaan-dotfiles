# Much of this file was taken from the system default bashrc file on debian strech /etc/bash.bashrc
#
# NOTE: in mac, this file needs to be sourced by ~/.bash_profile, and a line needs to be added to ~/.bash_profile to do this
#
# ~/.bashrc: executed by bash(1) for non-login shells.
# see /usr/share/doc/bash/examples/startup-files (in the package bash-doc)
# for examples

############ DEFAULT FILE. USER ADDITIONS AT BOTTOM
...
if [ "$color_prompt" = yes ]; then
    ...
    # [HH:MM]user@hostname:pwd
    #PS1='${debian_chroot:+($debian_chroot)}\[\033[03;31m\][\A]\[\033[03;00m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
    # user@hostname:pwd
